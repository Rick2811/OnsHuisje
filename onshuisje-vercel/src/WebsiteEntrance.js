...
// ---- Hardcoded startdata (samengevoegd; niets verwijderd) ----
let recipes = {
  Pastas: [
    {
    ...
    },
    {
      ...
      steps:
        "Stap 1 verwarm de oven voor op 200 graden en kook de macaroni maar haal er 2 minutne af zodat het net nog niet gaar is\n" +
    ...
    },
    {
      ...
      steps:
        "Stap 1 Kook de spaghetti volgens de aanwijzingen op de verpakking beetgaar. Doe ondertussen de slagroom in een kom, breek de eieren erboven en klop met een vork door elkaar. Rasp de kaas erboven en meng erdoor. Snijd de peterselie fijn.\n" +
  ...
  soepen: [
    ...
    },
    {
      ...
      steps:
        "Stap 1 snipper de uien hak de knoflook fijn en snijd de paprika,s in blokjes smelt de boter in een pan en bak daarin de uitjes knoflook en paprika 3 minuten.\n" +
    ...
    },
    {
      ...
      steps:
        "Stap 1 Verwarm de olie in een grote soeppan en fruit de uien op een lage stand in circa 5 minuten lichtbruin.\n" +
    ...
    },
    {
      ...
      steps:
        "Stap 1 Breng de bouillon aan de kook en voeg alle groenten en de balletjes in één keer toe. Laat de soep nog ca. 5 minuten zonder deksel zachtjes doorkoken tot alles beetgaar is.\n" +
    ...
    },
    {
      ...
      steps:
        "Stap 1 Kip in stukjes snijden en in bouillon doen \n" +
  ...
  italiaans: [
    {
      ...
      steps:
        "Stap 1 ui snipperen en in pan knoflook uit persen\n" +
    ...
    },
    {
      ...
      steps:
        "Stap 1 Verwarm de oven op 200 graden. Snipper de ui en knoflook. Fruit deze aan in een pan met een eetlepel olie. Voeg de risottorijst toe er bak 3 minuutjes mee.\n" +
    ...
    },
    {
      ...
      steps:
        "Stap 1 Kook de pasta volgens de aanwijzingen op de verpakking. Snijd ondertussen de zongedroogde tomaten in reepjes. Giet de pasta af, laat uitlekken en meng met de tomatenreepjes en 3 eetlepels olie uit de pot.\n" +
  ...
  mexiaans: [
    ...
    },
    {
      ...
      steps:
        "Stap 1 Bak het gehakt met de ui, knoflook, groene peper en tomaten kort aan in een pan. Voeg de kruiden toe en roer goed door.\n" +
  ...
  aziatisch: [
    {
      ...
      steps:
        "Stap 1 Kook de mie in een ruime hoeveelheid water met alle bouillonblokjes, giet het daarna af en spoel na met koud water, zet dit aan de kant\n" +
    ...
    },
    {
      ...
      steps:
        "Stap 1 Kook de rijst in kippenbouillon zoals aangegeven op de verpakking. Giet af, spreid uit op een bord of dienblad en laat volledig afkoelen.\n" +
    ...
    },
    {
      ...
      steps:
        "Stap 1 Meng het ei, sojasaus, rijstwijn, zout en peper in een kom. Voeg de varkensblokjes toe en laat 20 minuten marineren.Wentel de blokjes door de maizena tot ze goed bedekt zijn.\n" +
  ...
  streetfood: [
    {
      ...
      steps:
        "Stap 1 Meng de geraspte aardappel met de fijngesnipperde ui, het ei en de bloem goed door elkaar. Breng het geheel op smaak met wat versgemalen zout en peper en nootmuskaat.\n" +
    ...
    },
    {
      ...
      steps:
        "Stap 1 Verwarm de oven voor op 200 graden boven- en onderwarmte. Snijd de kipfilet in stukjes. Zet 3 bakjes klaar: één met geklutste eieren, één met bloem en één met verkruimelde Doritos. \n" +
  ...
  overig: [
    {
      ...
      steps:
        "Stap 1 Smelt voor de bechamelsaus de roomboter op een lage stand in een (steel)pan. Roer de bloem met een garde erdoorheen en laat 1 minuut al roerend garen. Voeg al roerend beetje bij beetje de melk toe. Voeg pas weer melk toe als de vorige portie is opgenomen.\n" +
    ...
    },
    {
      ...
      steps:
        "Stap 1 Verwarm de oven voor op 200 °C. Bak de frites in ca. 25 min. in de oven goudbruin.\n" +
  ...
  "hollandse pot": [
    {
      ...
      steps:
        "Stap 1 snipper de ui en snij de champignons\n" +
  ...
  "korte bereiding": [
    {
      ...
      steps:
        "Stap 1 verwarm de kipragout en verwarm de wraps voor 1 minuut in de magnetron op 600 watt \n" +
  ...
  sauzen: [
    {
      ...
      steps:
        "stap 1 snij 1 teentje knoflook pers de overige 4\n" +
    ...
    },
    {
      ...
      steps:
        "Stap 1 Doe het water, azijn, suiker, ketchup en sojasaus in een pannetje. Breng dit aan de kook en roer tot de suiker is opgelost.\n" +
...
(function init() {
  try {
    ...
    recipes = saved?.recipes || recipes; // hardcoded als fallback
  } catch {
...
function renderRecipes() {
  ...
  list.forEach((rec, idx) => $recipeList.appendChild(
    recipeCard(
      ...
      null,
      () => showRecipePage(rec, active) // klik → detail
    )
  ));
}
...
function renderSearchResults(q) {
  ...
  results.forEach(({ tab, rec }) => {
    const card = recipeCard(
      ...
      null,
      tab,
      () => { setActive(tab); $search.value = ""; showRecipePage(rec, tab); }
    );
...
function recipeCard(rec, onDelete, tabLabel, onOpen) {
  ...
  const left = document.createElement("div"); left.className = "card-title";
  ...
  if (onDelete) {
    ...
    del.onclick = (e) => { e.stopPropagation(); onDelete(); }; // voorkom openen
...
// === Snippet builder + popup ===
function buildSnippet(category, rec) {
  const cat = JSON.stringify(category);
  const ingLines = (rec.ingredients || []).map(i => `        ${JSON.stringify(i)}`).join(",\n");
  return `${cat}: [
    {
...
function showSnippetPopup(snippetText) {
  ...
  modal.style.background = "#121417"; modal.style.color = "white";
  modal.style.padding = "16px"; modal.style.borderRadius = "12px";
  modal.style.width = "min(800px, 95vw)"; modal.style.maxHeight = "80vh"; modal.style.overflow = "auto";
  modal.style.border = "1px solid rgba(255,255,255,0.15)"; modal.style.boxShadow = "0 10px 30px rgba(0,0,0,0.4)";

  const head = document.createElement("div");
  head.style.display = "flex"; head.style.justifyContent = "space-between"; head.style.gap = "8px";

  const h3 = document.createElement("h3"); h3.textContent = "Gegenereerde snippet"; h3.style.margin = "0"; h3.style.fontSize = "16px";

  const closeBtn = document.createElement("button");
  closeBtn.textContent = "Sluiten";
  closeBtn.style.border = "1px solid #444"; closeBtn.style.background = "transparent"; closeBtn.style.color = "white";
  closeBtn.style.padding = "4px 8px"; closeBtn.style.borderRadius = "6px";
  ...
  actions.style.marginTop = "8px"; actions.style.display = "flex"; actions.style.gap = "8px";

  const copyBtn = document.createElement("button");
  copyBtn.textContent = "Kopieer";
  copyBtn.style.border = "1px solid #444"; copyBtn.style.background = "transparent"; copyBtn.style.color = "white";
  copyBtn.style.padding = "6px 10px"; copyBtn.style.borderRadius = "6px";
...
function showRecipePage(rec, tabName) {
  ...
  page.innerHTML = `
    <header style="display:flex;justify-content:space-between;align-items:center;margin-bottom:20px;gap:8px">
      <div>
        <div class="muted" style="font-size:12px;opacity:.8">${escapeHtml(tabName||"")}</div>
        <h2 style="margin:4px 0">${escapeHtml(rec.title||"Recept")}</h2>
        <div>
      ...
      <div style="display:flex;gap:8px">
        <button class="btn" id="closeBtn">← Terug</button>
        <button class="btn" id="printBtn">Print</button>
      </div>
    </header>

    <section class="card" style="background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.08);padding:12px 14px;border-radius:12px;margin-bottom:14px">
      <h3 style="margin:0 0 8px 0">Ingrediënten</h3>
      ${((rec.ingredients||[]).length)
        ? `<ul style="margin:0;padding-left:18px">${(rec.ingredients||[]).map(i=>`<li style="margin:4px 0">${escapeHtml(i)}</li>`).join("")}</ul>`
        : "<p>—</p>"}
    </section>

    <section class="card" style="background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.08);padding:12px 14px;border-radius:12px">
      <h3 style="margin:0 0 8px 0">Bereiding</h3>
      <pre style="white-space:pre-wrap;line-height:1.55;margin:0">${escapeHtml(rec.steps||"—")}</pre>
    </section>
  `;
  ...
  page.querySelector("#closeBtn").addEventListener("click", close);
  page.querySelector("#printBtn").addEventListener("click", () => window.print());
